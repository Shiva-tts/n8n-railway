...
class WebhookContext extends node_execution_context_1.NodeExecutionContext {
    constructor(workflow, node, additionalData, mode, webhookData, closeFunctions, runExecutionData) {
        ...
        this.helpers = {
            ...
            ...(0, node_execute_functions_1.getRequestHelperFunctions)(workflow, node, additionalData),
    ...
    getNodeWebhookUrl(name) {
        return (0, node_execute_functions_1.getNodeWebhookUrl)(name, this.workflow, this.node, this.additionalData, this.mode, this.additionalKeys);
    }
    getWebhookName() {
