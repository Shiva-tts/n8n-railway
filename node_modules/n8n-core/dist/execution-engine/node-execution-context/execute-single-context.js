...
class ExecuteSingleContext extends base_execute_context_1.BaseExecuteContext {
    constructor(workflow, node, additionalData, mode, runExecutionData, runIndex, connectionInputData, inputData, itemIndex, executeData, abortSignal) {
        ...
        this.helpers = {
            ...
            assertBinaryData: (propertyName, inputIndex = 0) => (0, node_execute_functions_1.assertBinaryData)(inputData, node, itemIndex, propertyName, inputIndex),
            getBinaryDataBuffer: async (propertyName, inputIndex = 0) => await (0, node_execute_functions_1.getBinaryDataBuffer)(inputData, itemIndex, propertyName, inputIndex),
