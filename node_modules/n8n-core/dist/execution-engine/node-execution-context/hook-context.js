...
class HookContext extends node_execution_context_1.NodeExecutionContext {
    constructor(workflow, node, additionalData, mode, activation, webhookData) {
        ...
        this.helpers = (0, node_execute_functions_1.getRequestHelperFunctions)(workflow, node, additionalData);
    }
    getActivationMode() {
    ...
    getNodeWebhookUrl(name) {
        return (0, node_execute_functions_1.getNodeWebhookUrl)(name, this.workflow, this.node, this.additionalData, this.mode, this.additionalKeys, this.webhookData?.isTest);
    }
    getWebhookName() {
    ...
    getWebhookDescription(name) {
        return (0, node_execute_functions_1.getWebhookDescription)(name, this.workflow, this.node);
    }
}
