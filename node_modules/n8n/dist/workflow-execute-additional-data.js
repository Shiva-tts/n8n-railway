...
async function startExecution(additionalData, options, executionId, runData, workflowData) {
    ...
    try {
        ...
        additionalDataIntegrated.hooks = (0, execution_lifecycle_hooks_1.getWorkflowHooksIntegrated)(runData.executionMode, executionId, workflowData, additionalData.userId);
