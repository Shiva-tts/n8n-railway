...
let JobProcessor = class JobProcessor {
    ...
    async processJob(job) {
        ...
        additionalData.hooks = (0, execution_lifecycle_hooks_1.getWorkflowHooksWorkerExecuter)(execution.mode, job.data.executionId, execution.workflowData, { retryOf: execution.retryOf, pushRef });
        if (pushRef) {
