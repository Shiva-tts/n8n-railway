...
export declare class WorkflowRunner {
    ...
    constructor(logger: Logger, errorReporter: ErrorReporter, activeExecutions: ActiveExecutions, executionRepository: ExecutionRepository, externalHooks: ExternalHooks, workflowStaticDataService: WorkflowStaticDataService, nodeTypes: NodeTypes, permissionChecker: PermissionChecker, instanceSettings: InstanceSettings, manualExecutionService: ManualExecutionService);
