const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/NodeCreator-DTMPwVj5.js","assets/index-DablXALM.js","assets/index-Bs_8II2j.css","assets/useCanvasOperations-CEPzjX8I.js","assets/usePinnedData-BEOJK2e-.js","assets/useCanvasOperations-CEWecDkR.css","assets/NodeCreator-DDiuO5S0.css"])))=>i.map(i=>d[i]);
import { bo as useNodeTypesStore, dE as NODE_CREATOR_OPEN_SOURCES, q as computed, g as useI18n, bI as MANUAL_TRIGGER_NODE_TYPE, ig as CHAIN_LLM_LANGCHAIN_NODE_TYPE, bh as NodeConnectionType, b7 as CHAT_TRIGGER_NODE_TYPE, ih as OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE, ii as OPEN_AI_NODE_TYPE, ha as SPLIT_IN_BATCHES_NODE_TYPE, di as NO_OP_NODE_TYPE, T as useWorkflowsStore, aT as useExternalHooks, bJ as WEBHOOK_NODE_TYPE, gR as SCHEDULE_TRIGGER_NODE_TYPE, aB as STICKY_NODE_TYPE, $ as useCanvasStore, gF as AI_CATEGORY_LANGUAGE_MODELS, dP as TRIGGER_NODE_CREATOR_VIEW, ij as QA_CHAIN_NODE_TYPE, ik as AGENT_NODE_TYPE, il as BASIC_CHAIN_NODE_TYPE, im as OPEN_AI_ASSISTANT_NODE_TYPE, d as defineComponent, K as useUIStore, r as ref, c9 as useThrottleFn, o as onMounted, x as onBeforeUnmount, m as resolveComponent, c as openBlock, h as createElementBlock, n as normalizeClass, j as createBaseVNode, i as createVNode, w as withCtx, l as unref, dD as KeyboardShortcutTooltip, f as createCommentVNode, e as createBlock, cr as Suspense, F as Fragment, cC as defineAsyncComponent, ar as __vitePreload, io as getMidCanvasPosition, ip as DEFAULT_STICKY_WIDTH, iq as DEFAULT_STICKY_HEIGHT, _ as _export_sfc } from "./index-DablXALM.js";
import { a as useNodeCreatorStore, t as transformNodeType, s as sortNodeCreateElements } from "./useCanvasOperations-CEPzjX8I.js";
const useActions = () => {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const LazyNodeCreator = defineAsyncComponent(
      async () => await __vitePreload(() => import("./NodeCreator-DTMPwVj5.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6]) : void 0)
    );
    const props = __props;
    const emit = __emit;
